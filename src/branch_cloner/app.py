from schema.aws.codepipeline.codepipelinepipelineexecutionstatechange import Marshaller
from schema.aws.codepipeline.codepipelinepipelineexecutionstatechange import AWSEvent
from schema.aws.codepipeline.codepipelinepipelineexecutionstatechange import (
...
def lambda_handler(event, context):
    ...
    detail: CodePipelinePipelineExecutionStateChange = awsEvent.detail
